...
The Global Rights Innovation Lab (GRIL) Clinic at Berkeley Law stands at the cutting edge of global rights advocacy, strategically leveraging the power of technology to drive evidence-based justice. Our mission is to revolutionize how rights are protected and enforced in the digital age.
...
We also develop tools! You can find them in our organization. 
...
- 55 languages: The default settings will allow you to translate PDFs or Word documents across 55 languages.   

- Private and local: Olladoc runs directly on your computer, meaning your documents never leave your machine or get sent to third-party servers.  

- Custom glossaries: You can create custom glossaries to lock in exact terms. For example, you can keep names in their original language or provide a specific translation for a highly technical term.  

- Open-source transparency: Olladoc's code is publicly available for you to view, use or even adapt.  
